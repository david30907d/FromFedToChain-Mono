...
export interface DatabasePublic {
  Tables: {
    ...
    episode_localizations: {
      Row: EpisodeLocalizationRow;
      Insert: Omit<NewEpisodeLocalization, 'id'> & { id?: string };
      Update: Partial<NewEpisodeLocalization>;
    };
    language_classrooms: {
...
export const LANGUAGE_CLASSROOM_LANGUAGE_CODES = [DEFAULT_LANGUAGE_CODE, 'ja', 'en'] as const;
